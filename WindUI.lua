--[[
    ...
    [ MoonUI Mod ]
    1. 悬浮窗（OpenButton）全平台显示（原版仅手机端显示，现 PC 端也显示）
    2. 悬浮窗替换为流光渐变药丸样式：标题 · FPS · Ping，支持拖拽
    3. 内置 14 套流光主题，可用 WindUI:SetFloatTheme(name) / Window:SetFloatTheme(name) 切换
       主题列表: WindUI.FloatThemeOrder / WindUI.FloatThemes
    4. 悬浮窗与主窗口的开合动画已适配（药丸缩放过渡）
...
-- [ MoonUI Mod ] 悬浮窗：流光渐变药丸（标题 · FPS · Ping），全平台显示
local RunService=ae(game:GetService"RunService")
local StatsService=ae(game:GetService"Stats")

aa.Themes={
["极光紫"]={Color3.fromRGB(60,20,140),Color3.fromRGB(140,60,220),Color3.fromRGB(220,100,255),Color3.fromRGB(140,60,220),Color3.fromRGB(60,20,140)},
["星河银"]={Color3.fromRGB(50,50,60),Color3.fromRGB(140,140,150),Color3.fromRGB(220,220,230),Color3.fromRGB(140,140,150),Color3.fromRGB(50,50,60)},
["鎏金"]={Color3.fromRGB(80,50,10),Color3.fromRGB(200,150,50),Color3.fromRGB(255,220,100),Color3.fromRGB(200,150,50),Color3.fromRGB(80,50,10)},
["玫瑰金"]={Color3.fromRGB(100,50,60),Color3.fromRGB(220,120,140),Color3.fromRGB(255,180,190),Color3.fromRGB(220,120,140),Color3.fromRGB(100,50,60)},
["深海极光"]={Color3.fromRGB(10,30,80),Color3.fromRGB(30,120,200),Color3.fromRGB(80,220,250),Color3.fromRGB(30,120,200),Color3.fromRGB(10,30,80)},
["极光翠"]={Color3.fromRGB(10,60,40),Color3.fromRGB(40,180,120),Color3.fromRGB(120,255,180),Color3.fromRGB(40,180,120),Color3.fromRGB(10,60,40)},
["日落橙"]={Color3.fromRGB(80,30,10),Color3.fromRGB(230,100,30),Color3.fromRGB(255,180,60),Color3.fromRGB(230,100,30),Color3.fromRGB(80,30,10)},
["樱花粉"]={Color3.fromRGB(100,40,70),Color3.fromRGB(240,120,180),Color3.fromRGB(255,190,220),Color3.fromRGB(240,120,180),Color3.fromRGB(100,40,70)},
["冰蓝"]={Color3.fromRGB(20,50,100),Color3.fromRGB(80,160,255),Color3.fromRGB(180,230,255),Color3.fromRGB(80,160,255),Color3.fromRGB(20,50,100)},
["翡翠绿"]={Color3.fromRGB(10,60,30),Color3.fromRGB(30,180,90),Color3.fromRGB(100,255,140),Color3.fromRGB(30,180,90),Color3.fromRGB(10,60,30)},
["烈焰红"]={Color3.fromRGB(100,10,10),Color3.fromRGB(230,40,40),Color3.fromRGB(255,100,80),Color3.fromRGB(230,40,40),Color3.fromRGB(100,10,10)},
["星空黑"]={Color3.fromRGB(10,10,20),Color3.fromRGB(40,40,80),Color3.fromRGB(100,90,180),Color3.fromRGB(40,40,80),Color3.fromRGB(10,10,20)},
["浅蓝"]={Color3.fromRGB(50,80,180),Color3.fromRGB(100,150,255),Color3.fromRGB(200,220,255),Color3.fromRGB(100,150,255),Color3.fromRGB(50,80,180)},
["彩虹"]={Color3.fromRGB(255,50,50),Color3.fromRGB(255,150,50),Color3.fromRGB(255,240,50),Color3.fromRGB(50,220,100),Color3.fromRGB(50,150,255),Color3.fromRGB(180,50,255)},
}

aa.ThemeOrder={"极光紫","星河银","鎏金","玫瑰金","深海极光","极光翠","日落橙","樱花粉","冰蓝","翡翠绿","烈焰红","星空黑","浅蓝","彩虹"}

local function BuildGradient(af)
local ag=af
if af[1]~=af[#af]then
ag={table.unpack(af)}
table.insert(ag,af[1])
end
local ah={}
for ai,aj in ipairs(ag)do
ah[ai]=ColorSequenceKeypoint.new((ai-1)/(#ag-1),aj)
end
return ColorSequence.new(ah)
end
...
ao=false
local ar=ad(ak.UIScale,.22,{Scale=.6},Enum.EasingStyle.Quint,Enum.EasingDirection.In)
ar:Play()
...
function ag.SetTheme(ap,aq)
local ar=aa.Themes[aq]
if not ar then
return
end
ag.CurrentTheme=aq
ak.UIGradient.Color=BuildGradient(ar)
ak.BackgroundColor3=ar[math.ceil(#ar/2)]
end
...
if aq.Theme then
ag:SetTheme(aq.Theme)
end
if aq.Color then
ak.UIGradient.Color=aq.Color
end
if aq.Title then
af.Title=aq.Title
end
...
return at and math.floor(au) or 0
end

ab.AddSignal(RunService.RenderStepped,function(at)
flowOffset=(flowOffset+at*flowSpeed)%2
ak.UIGradient.Offset=Vector2.new(flowOffset-1,0)
timeAccum=timeAccum+at
if timeAccum>=.5 then
timeAccum=0
local au=math.floor(1/math.max(at,.0001))
fps=math.floor(fps*.8+au*.2)
ai.Text=string.format("%s · FPS: %d · Ping: %d",af.Title or "WindUI",fps,GetPing())
end
end)

ag:SetTheme(ag.CurrentTheme)
...
function as.SetFloatTheme(p,r)
if as.OpenButtonMain then
as.OpenButtonMain:SetTheme(r)
end
return as
end

function as.GetFloatTheme(p)
return as.OpenButtonMain and as.OpenButtonMain.CurrentTheme or nil
end

function as.SetFloatVisible(p,r)
if as.OpenButtonMain then
as.OpenButtonMain:Visible(r)
end
return as
end
...
aa.FloatThemes=a.load'x'.Themes
aa.FloatThemeOrder=a.load'x'.ThemeOrder

function aa.SetFloatTheme(ax,ay)
if aa.Window then
aa.Window:SetFloatTheme(ay)
end
end

function aa.GetFloatThemes(ax)
return aa.FloatThemeOrder
end
